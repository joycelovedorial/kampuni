<template>
    <div class="centered-component rounded-lg p-5 rounded-2 border-2 border-black space-y-2 font-fredoka" v-if="toEdit">
        <div class="text-b">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
       ...
       <div class="flex justify-center">
        <button class="rounded-lg border-b border-2 text-b px-2">
            edit
        </button>
       </div>
...
export default {
   ...
   setup(props,context){
       ...
       return{
           title,location,description,date,time,toEdit,editOuting,etitle,elocation,edesc,edate,etime
       }
   }
}
</script>
