<template>
    <div class=" place-content-around items-center">
        <button class="bg-bpop text-black grow font-bold w-11/12 rounded-full py-2 hover:drop-shadow-md hover:opacity-90" @click="$emit('eCreate')">
        ...
        <div class="my-2 overflow-x-hidden ">
            <div class="overflow-y-auto custom_class_2">
            <div v-for="task in tasksFormatted" :key="task.id" class="bg-white flex items-center m-2 rounded-md h-24"> <!-- Add a flex container for side-by-side elements -->
