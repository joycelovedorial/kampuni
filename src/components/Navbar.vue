<template>
  <div class="object-right w-auto">
    <nav class="bg-cyans bg-opacity-75 py-1 flex justify-between items-center">
      <img class="logo inline" src="../assets/kampuni_logo.png" alt="">
      <ul class="flex space-x-4">
        <router-link to="../Homepage" class="button text-cyanp font-bold">
        ...
        <router-link to="../chatroom/Chatrooms" class="button text-cyanp font-bold">
