<template>
  <div
    class="rounded-lg bg-b border-2 border-black p-2 w-100"
    :class="{
      // 'border-g': involved,
      // 'border-r': !involved,
      'border-orange': null,
  ...
  >
    ...
    <div class="col-12" id="detail-container">
      <div
        class="w-auto justify-content-center align-middle border-2 bg-bnorm border-black truncate"
        id="name_container"
        style="
          height: fit-content;
          width: fit-content;
    ...
    <div class="space-y-2 m-2">
      ...
      <div class="flex justify-start">
        ...
        <p v-for="(name, i) in joined" :key="i">
          {{ name }}
          <svg fill="fill" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-2 h-2 inline">
